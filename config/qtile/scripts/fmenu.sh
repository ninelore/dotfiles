...
if ( ! $DRY )
then
    cat "$INDEX" | `dmenu -i  -nb "#262626" -nf "#73b3e7" -sb "#73b3e7" -sf "#262626" -fn "NotoMonoRegular:pixelsize=16" $DMENU > /tmp/dmenu_find_output.txt` && cat /tmp/dmenu_find_output.txt | xargs xdg-open
fi
